    ...
    <header class="flex justify-between w-full items-center">
        <ul class="flex gap-4 flex-col">
            <div class="flex gap-5 items-center">
                ...
                <li class="">
                    <p class="uppercase font-semibold text-3xl text-white">
                        Los mercenarios
                    </p>
                </li>
            </div>
        ...
        <div>
            <button class="rounded-full border-2 text-white border-red-500 relative text-sm font-semibold h-8 w-8">
                X
            </button>
        </div>
    </header>
